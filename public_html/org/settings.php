...
use App\Controllers\OrganizationSettingsController;
...
$controller = new OrganizationSettingsController($service, $userRepository);
...
$controller->show($requestedOrgId ?? $domainOrg->id);
